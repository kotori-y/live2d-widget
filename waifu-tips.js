...
function loadWidget(waifuPath, apiPath) {
	...
	function welcomeMessage() {
		...
		if (location.pathname === "/") { // 如果是主页
			...
			if (location.hostname == referrer.hostname) && (document.title.split(" - ")[0] == "摸鱼的日常|Daily Cyberslacking | Power, Wisdom and Courage") text = '你即将踏入人类的黑暗面';
			else if (location.hostname == referrer.hostname) && (document.title.split(" - ")[0] != "摸鱼的日常|Daily Cyberslacking | Power, Wisdom and Courage") text = `欢迎阅读<span>「${document.title.split(" - ")[0]}」</span>`;
